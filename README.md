...
Of 19 novelty-matrix columns, 18 are occupied. No occupying prior art was
identified in the searched corpus for the nineteenth, *dispatch-by deadline*.
That is the program's candidate contribution — see
`novelty/FINAL_NOVELTY_RESOLUTION.md` for what survives full-text comparison.
...
python3 bibliography/build_claims.py          # claims.yaml -> registry + all counts
