...
| 4.9 | "how good"/"how skillful" must a forecast be threshold before forecast-based action beats climatology | WebSearch | **`raeth2026decisionskill` (critical)**; `bouttier2024optimal` (**key**) |
